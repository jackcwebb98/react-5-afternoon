...
import { loanUpdater, propertyUpdater } from '../../ducks/reducer'
class WizardOne extends Component {
    render(){
        const { loanUpdater, propertyUpdater } = this.props
        return(
            <div className="parent-div">
                <div className="vert-align">
                    <p>What type of loan will you be needing?</p> <br />
                
                    <select onChange={(e) => loanUpdater(e.target.value)}>
                    ...
                    <select onChange={(e) => propertyUpdater(e.target.value)}>
...
export default connect( mapStateToProps, {loanUpdater, propertyUpdater})(WizardOne); 