...
export function loanUpdater(loanType){
    return {
...
export function propertyUpdater (property) {
    return{
...
export function cityUpdater (city) {
    return{
        type: UPDATE_CITY,
        payload: city
    }
...
export function propUpdater (prop){
    return{
        type: UPDATE_PROP,
        payload: prop
    }
...
export function realEstateAgentUpdater(realEstateAgent){
    return{
